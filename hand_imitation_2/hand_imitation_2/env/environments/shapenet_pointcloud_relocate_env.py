...
class SHAPENETPCRelocate(MujocoEnv):
    ...
    def _load_model(self):
        ...
        try:
            self.obj = trimesh.load(f'hand_imitation_2/hand_imitation/env/models/assets/shapenet_{self.category}/visual/{self.object_name}/model_transform_scaled.obj') 
        except:
            self.obj = trimesh.load(f'{sys.path[-1]}/hand_imitation_2/hand_imitation/env/models/assets/shapenet_{self.category}/visual/{self.object_name}/model_transform_scaled.obj')
